...
//#
//# $Id: FTMachineSplitBeamWStackSingleGrid.h 28017 2014-01-23 13:01:00Z vdtol $

#ifndef LOFARFT_LOFARFTMACHINE_WSTACK_SPLITBEAM_SINGLEGRID_H
#define LOFARFT_LOFARFTMACHINE_WSTACK_SPLITBEAM_SINGLEGRID_H
...
//	  casa::String convType="SF", casa::Float padding=1.0, casa::Bool usezero=casa::True, casa::Bool useDoublePrec=casa::False);
  ...
  virtual casa::String name() const { return "FTMachineSplitBeamWStackSingleGrid";};

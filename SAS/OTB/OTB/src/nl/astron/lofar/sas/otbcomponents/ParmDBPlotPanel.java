 ...
 * @author  pompert
 * @version $Id: ParmDBPlotPanel.java 22347 2012-10-16 07:56:29Z coolen $
 */
public class ParmDBPlotPanel extends javax.swing.JPanel implements IViewPanel{
    ...
    private Object constructPlotterConstraints(String aParamName,String itsParamTableName){
        ...
        if (aParamName != null) {
            ...
            logger.error("no Param Name given");
        }
    ...
    public void setContent(Object anObject) {
        ...
        try {
            ...
            String aS="setContent() - jParmFacade RMI error while updating table name "+ex;
            logger.error(aS);
    ...
    private void initComponents() {
        ...
        bClearSlots.setIcon(new javax.swing.ImageIcon(getClass().getResource("/nl/astron/lofar/sas/otb/icons/16_delAll.gif"))); // NOI18N
        bClearSlots.setText("Clear Slots");
        bClearSlots.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        bHelp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/nl/astron/lofar/sas/otb/icons/16_help.png"))); // NOI18N
        bHelp.setText("Help");
        bHelp.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);

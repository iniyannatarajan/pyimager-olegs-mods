 ...
 * @author  coolen
 *
 * @version $Id: VICnodeDefViewPanel.java 16103 2010-07-30 11:01:55Z coolen $
 */
public class VICnodeDefViewPanel extends javax.swing.JPanel implements IViewPanel{
    ...
    private void setClassif(String aSt) {
        try {
            this.ClassificationText.setSelectedItem(OtdbRmi.getRemoteTypes().getClassif(aSt));
        } catch (RemoteException e) {
            String aS="Error: GetParamType("+aSt+") failed " + e;
            logger.error(aS);
    ...
    private void initComponents() {
        ...
        NodeCancelButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/nl/astron/lofar/sas/otb/icons/16_cancel.png"))); // NOI18N
        NodeCancelButton.setText("Cancel");
        NodeCancelButton.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        NodeApplyButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/nl/astron/lofar/sas/otb/icons/16_apply.png"))); // NOI18N
        NodeApplyButton.setText("Apply");
        NodeApplyButton.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);

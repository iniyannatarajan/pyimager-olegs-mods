 ...
 * @author  coolen
 *
 * @version $Id: NodeViewPanel.java 21295 2012-06-26 08:03:01Z coolen $
 *
 */
        ...
        if(userAccount.isInstrumentScientist()) {
         ...
         if (itsNode != null) {
            try {
                ...
                String aS="NodeViewPanel: Error getting treeInfo/treetype" + ex;
                logger.error(aS);
                LofarUtils.showErrorPanel(this,aS,new javax.swing.ImageIcon(getClass().getResource("/nl/astron/lofar/sas/otb/icons/16_warn.gif")));
                itsTreeType="";
            }
            ...
            try {
                ...
                if (hasChanged) {
                    if (!OtdbRmi.getRemoteMaintenance().saveNode(itsNode)) {
                        String aS="Saving node "+itsNode.name+" failed: "+ OtdbRmi.getRemoteMaintenance().errorMsg();
                        logger.error(aS);
                        LofarUtils.showErrorPanel(this,aS,new javax.swing.ImageIcon(getClass().getResource("/nl/astron/lofar/sas/otb/icons/16_warn.gif")));
                    }
                } 

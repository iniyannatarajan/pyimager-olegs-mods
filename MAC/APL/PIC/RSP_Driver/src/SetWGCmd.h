//#  -*- mode: c++ -*-
//#
//#  SetWGCmd.h: Beamformer Weights settings command.
//#
...
//#
//#  $Id: SetWGCmd.h 7595 2006-02-07 07:46:25Z overeem $
...
namespace LOFAR {
  namespace RSP {
    ...
    public:
       ...
       */
      SetWGCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for SetWGCmd. */
      virtual ~SetWGCmd();

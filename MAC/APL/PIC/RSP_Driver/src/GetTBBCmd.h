...
//#
//#  $Id: GetTBBCmd.h 13440 2009-06-22 13:26:54Z overeem $
...
namespace LOFAR {
  namespace RSP {
    ...
    class GetTBBCmd : public Command
    {
    public:
      /**
       * Constructors for a GetTBBCmd object.
       */
      GetTBBCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for GetTBBCmd. */
      virtual ~GetTBBCmd();

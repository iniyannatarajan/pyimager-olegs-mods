//#  -*- mode: c++ -*-
//#
//#  GetTDStatusCmd.h: Get system status command.
//#
...
//#
//#  $Id: GetTDStatusCmd.h 13440 2009-06-22 13:26:54Z overeem $

#ifndef GETTDSTATUSCMD_H_
#define GETTDSTATUSCMD_H_
...
namespace LOFAR {
  namespace RSP {
    ...
    class GetTDStatusCmd : public Command
    {
    public:
      /**
       * Constructors for a GetTDStatusCmd object.
       */
      GetTDStatusCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for GetTDStatusCmd. */
      virtual ~GetTDStatusCmd();
    ...
    private:
      GetTDStatusCmd();				// Default construction is not allowed.

      RSPGettdstatusEvent* m_event;
    };
  };
};
     
#endif /* GETTDSTATUSCMD_H_ */

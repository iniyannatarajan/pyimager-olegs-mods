//#  -*- mode: c++ -*-
//#
//#  UpdRCUCmd.h: RCU selection upd command.
//#
...
//#
//#  $Id: UpdRCUCmd.h 7595 2006-02-07 07:46:25Z overeem $
...
namespace LOFAR {
  namespace RSP {
    ...
    class UpdRCUCmd : public Command
    {
    public:
      /**
       * Constructors for a UpdRCUCmd object.
       */
      UpdRCUCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for UpdRCUCmd. */
      virtual ~UpdRCUCmd();

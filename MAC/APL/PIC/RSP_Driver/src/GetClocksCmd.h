//#  -*- mode: c++ -*-
//#
//#  GetClocksCmd.h: Beamformer Weights settings command.
//#
...
//#
//#  $Id: GetClocksCmd.h 13440 2009-06-22 13:26:54Z overeem $

#ifndef GETCLOCKSCMD_H_
#define GETCLOCKSCMD_H_
...
namespace LOFAR {
  namespace RSP {
    ...
    class GetClocksCmd : public Command
    {
    public:
      /**
       * Constructors for a GetClocksCmd object.
       */
      GetClocksCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for GetClocksCmd. */
      virtual ~GetClocksCmd();

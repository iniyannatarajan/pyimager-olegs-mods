//#  -*- mode: c++ -*-
//#
//#  UpdClocksCmd.h: Get system status command.
//#
...
//#
//#  $Id: UpdClocksCmd.h 9379 2006-10-04 15:00:52Z wierenga $

#ifndef UPDCLOCKSCMD_H_
#define UPDCLOCKSCMD_H_
...
namespace LOFAR {
  namespace RSP {
    ...
    public:
       ...
       */
      UpdClocksCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for UpdClocksCmd. */
      virtual ~UpdClocksCmd();
    ...
    private:
      ...
      uint32            m_current_clock;
    };
  };
};
     
#endif /* UPDCLOCKSCMD_H_ */

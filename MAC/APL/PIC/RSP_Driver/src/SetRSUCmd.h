//#  -*- mode: c++ -*-
//#
//#  SetRSUCmd.h: Beamformer Weights settings command.
//#
...
//#
//#  $Id: SetRSUCmd.h 7595 2006-02-07 07:46:25Z overeem $
...
namespace LOFAR {
  namespace RSP {
    ...
    class SetRSUCmd : public Command
    {
    public:
      /**
       * Constructors for a SetRSUCmd object.
       */
      SetRSUCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for SetRSUCmd. */
      virtual ~SetRSUCmd();

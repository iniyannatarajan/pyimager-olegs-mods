//#  -*- mode: c++ -*-
//#
//#  GetVersionsCmd.h: Beamformer Weights settings command.
//#
...
//#
//#  $Id: GetVersionsCmd.h 13440 2009-06-22 13:26:54Z overeem $

#ifndef GETVERSIONSCMD_H_
#define GETVERSIONSCMD_H_
...
namespace LOFAR {
  namespace RSP {
    ...
    public:
       ...
       */
      GetVersionsCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);

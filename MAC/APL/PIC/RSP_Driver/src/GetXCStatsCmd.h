//#  -*- mode: c++ -*-
//#
//#  GetXCStatsCmd.h: Beamformer Stats get command.
//#
...
//#
//#  $Id: GetXCStatsCmd.h 13440 2009-06-22 13:26:54Z overeem $

#ifndef GETXCSTATSCMD_H_
#define GETXCSTATSCMD_H_
...
namespace LOFAR {
  namespace RSP {
    ...
    class GetXCStatsCmd : public Command
    {
    public:
      /**
       * Constructors for a GetXCStatsCmd object.
       */
      GetXCStatsCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for GetXCStatsCmd. */
      virtual ~GetXCStatsCmd();

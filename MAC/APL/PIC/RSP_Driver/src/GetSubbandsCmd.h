//#  -*- mode: c++ -*-
//#
//#  GetSubbandsCmd.h: Beamformer Weights settings command.
//#
...
//#
//#  $Id: GetSubbandsCmd.h 13440 2009-06-22 13:26:54Z overeem $

#ifndef GETSUBBANDSCMD_H_
#define GETSUBBANDSCMD_H_
...
namespace LOFAR {
  namespace RSP {
    ...
    public:
       ...
       */
      GetSubbandsCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for GetSubbandsCmd. */
      virtual ~GetSubbandsCmd();

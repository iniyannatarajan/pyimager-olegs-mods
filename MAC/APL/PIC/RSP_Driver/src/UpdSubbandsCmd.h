//#  -*- mode: c++ -*-
//#
//#  UpdSubbandsCmd.h: Subband selection upd command.
//#
...
//#
//#  $Id: UpdSubbandsCmd.h 7595 2006-02-07 07:46:25Z overeem $

#ifndef UPDSUBBANDSCMD_H_
#define UPDSUBBANDSCMD_H_
...
namespace LOFAR {
  namespace RSP {
    ...
    class UpdSubbandsCmd : public Command
    {
    public:
      /**
       * Constructors for a UpdSubbandsCmd object.
       */
      UpdSubbandsCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for UpdSubbandsCmd. */
      virtual ~UpdSubbandsCmd();
    ...
    private:
      ...
      RSPSubsubbandsEvent* m_event;
    };
  };
};
     
#endif /* UPDSUBBANDSCMD_H_ */

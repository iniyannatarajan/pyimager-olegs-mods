//#  -*- mode: c++ -*-
//#
//#  UpdXCStatsCmd.h: Beamformer Stats upd command.
//#
...
//#
//#  $Id: UpdXCStatsCmd.h 7595 2006-02-07 07:46:25Z overeem $

#ifndef UPDXCSTATSCMD_H_
#define UPDXCSTATSCMD_H_
...
namespace LOFAR {
  namespace RSP {
    ...
    public:
       ...
       */
      UpdXCStatsCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for UpdXCStatsCmd. */
      virtual ~UpdXCStatsCmd();

//#  -*- mode: c++ -*-
//#
//#  SetTBBCmd.h: Beamformer Weights settings command.
//#
...
//#
//#  $Id: SetTBBCmd.h 9655 2006-11-17 16:17:00Z wierenga $
...
namespace LOFAR {
  namespace RSP {
    ...
    class SetTBBCmd : public Command
    {
    public:
      /**
       * Constructors for a SetTBBCmd object.
       */
      SetTBBCmd(GCFEvent& event, GCFPortInterface& port, Operation oper);
	  
      /* Destructor for SetTBBCmd. */
      virtual ~SetTBBCmd();

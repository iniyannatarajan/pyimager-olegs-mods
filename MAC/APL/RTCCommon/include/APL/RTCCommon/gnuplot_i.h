...
/*
	$Id: gnuplot_i.h 15658 2010-05-11 10:21:55Z loose $
	$Author: loose $
	$Date: 2010-05-11 10:21:55 +0000 (Tue, 11 May 2010) $
	$Revision: 15658 $
 */
 ...
 */
/*--------------------------------------------------------------------------*/
gnuplot_ctrl * gnuplot_init(const char* display_ = NULL);
...
/*-------------------------------------------------------------------------*/
/**
  @brief    Plot a 3D surface of the provided matrix.
  @param    h           Gnuplot session control handle.
  @param    matrix      Matrix to plot.
  @param    title       Title of the plot.
  @return   void

  Plots out a surface of given matrix.

  Example:

  @code
        gnuplot_ctrl        *h ;
        Array<double, 2>    matrix(4,4) ;
        ...
        matrix = 1,2,3,4,
                 ...
                 1,2,3,4,
                 4,3,2,1;
        gnuplot_splot(h, matrix, "Matrix") ;
        gnuplot_close(h) ;
  @endcode
 */
/*--------------------------------------------------------------------------*/
void gnuplot_splot(gnuplot_ctrl * h, blitz::Array<double, 2> matrix, const char * title) ;

void gnuplot_contour_plot(gnuplot_ctrl * h, blitz::Array<double, 2> matrix, const char * title) ;
#endif

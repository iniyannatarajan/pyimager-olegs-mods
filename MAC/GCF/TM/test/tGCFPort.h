//
//  tGCFPort.h: Test program to test all kind of usage of the GCF ports.
//
//  Copyright (C) 2006
...
//
//  $Id: tGCFPort.h 8493 2006-05-29 10:19:13Z overeem $
//
...
private:
	...
	GCFPort*	itsClientPort;
	uint32		itsTimeoutTimer;
	uint32		itsFinishedTimer;
};

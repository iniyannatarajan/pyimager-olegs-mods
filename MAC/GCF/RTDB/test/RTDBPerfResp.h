//  RTDBPerfResp.h: Concrete GSAResponse class definition.
//
//  Copyright (C) 2007
...
//
//  $Id: RTDBPerfResp.h 13145 2009-04-22 08:47:05Z overeem $
//
...
class RTDBPerfResp : public PVSSresponse
{
public:
    RTDBPerfResp() {};
    virtual ~RTDBPerfResp() {};

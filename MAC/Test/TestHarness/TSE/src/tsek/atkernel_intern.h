...
/* The only purpose of this file is to provide access to two functions.     */
/* This is needed, because in the atkernel.c a statemachine is used,        */
/* keeping track of the internal state of the kernel.                       */
